...
class SDL {	
    ...
    alias uint function(PixelFormat *fmt, ubyte r, ubyte g, ubyte b) SDL_MapRGB;
    alias int function(Surface* screen) SDL_Flip;
  ...
  mixin( dll_declare( "SDL_MapRGB") );
  mixin( dll_declare( "SDL_Flip") );
    ...
    mixin( dll_init( "SDL_MapRGB") );
    mixin( dll_init( "SDL_Flip") );
